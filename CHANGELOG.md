...
- Added the first manual theme-level no-self parallel collation evidence note, plus fixture validation support for `manual_theme_collation_recorded` candidate evidence without provider calls or platform-status changes.
