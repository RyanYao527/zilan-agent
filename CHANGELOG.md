...
- Added a "For Engineers" section to `README.md`, pitching the output-contract pattern and engineering metrics (182 tests, 86% coverage, mypy/ruff clean) to LLM reliability engineers before the Buddhist-domain content.
