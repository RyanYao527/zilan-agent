...
| `2026-08-19-srq06-srq07-srq10-srq11-runtime-spot-review.md` | Reviews 2026-08-19 Claude Code direct runtime spot answers for `SRQ-06`, `SRQ-07`, `SRQ-10`, and `SRQ-11` | partial | Original #193 evidence recorded four strict literal fails; current calibrated replay reports `SRQ-06` / `SRQ-07` pass and keeps `SRQ-10` / `SRQ-11` fail. |
