...
| P1 | Semantic retrieval | Add a reviewed fixture-refresh workflow that compares generated Agama candidates with the checked-in semantic fixture. | Candidate generation can support fixture updates without auto-overwriting checked-in chunks, while avoiding embeddings or vector storage. |
