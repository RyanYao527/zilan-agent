...
| P1 | Semantic retrieval | Implement the first fixture-based dry run from `docs/architecture/semantic-retrieval-interface.md`. | A local fixture validates source-file existence, line-range sanity, and stable citation fields before any vector database or embedding provider is introduced. |
